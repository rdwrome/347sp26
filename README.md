...
140character Assignment|20%
Code Analysis Presentation|20%
Sharing is Caring Project|20%
**Total**|**100%**
...
### Documentation File outline
  - The documentation file (**always** in Markdown, saved as a .md file) must have the following:
    ...
    - *what code you used from others/elsewhere*
      ...
      - other folks' GitHub public repositories and language forums are the best places to go for help most of the time
   ...
   - In general (unless I specify otherwise), it is permissible to use chat-GPT or other large-language models(LLMs) under the following circumstances:
      - You document the **ENTIRE INTERACTION** with screenshots and include images of those screen shots with your documentation.
      - You write out *in your own words* your **SPECIFIC** understanding of what you learned from the LLM in your documentation file.
	  - **If UNDERDOCUMENTED or UNDOCUMENTED LLM USE IS SUSPECTED YOU MAY BE GRADED ON HANDWRITTEN PSEUDOCODE IN CLASS.** 
	  - Underdocumented or Undocumented LLM use will be investigated with LLMs and may result in no credit given.
## Instructor Info
